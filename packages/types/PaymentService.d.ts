...
export interface IAbstractPaymentService {
  ...
  /* This method charges a partial deposit at booking time and stores the payment method for the remainder */
  createDeposit(
    payment: Pick<Prisma.PaymentUncheckedCreateInput, "amount" | "currency">,
  ...
  /* This method charges the remaining balance after a deposit was paid */
  chargeRemaining(
    payment: Payment,
    bookingId: Booking["id"]
  ): Promise<Payment>;
  /* This method creates a separate payment intent for an optional tip */
  createTip(
    payment: Pick<Prisma.PaymentUncheckedCreateInput, "amount" | "currency">,
    bookingId: Booking["id"],
    userId: Booking["userId"],
